...
FACEBOOK_URL_REGEXS = [
    '^http(s)?://(www\.)?(facebook|fb)\.com/[A-Za-z0-9_\-\.]+/?$',
]
...
LINKEDIN_URL_REGEXS = [
    ...
    '^http(s)?://([\w]+\.)?linkedin\.com/pub/[A-Za-z0-9_-]+(\/[A-z 0-9]+){3}/?$',
    # companies
    '^http(s)?://(www\.)?linkedin\.com/company/[A-Za-z0-9_-]+/?$',
]

TWITTER_URL_REGEXS = [
    '^http(s)?://(.*\.)?twitter\.com\/[A-Za-z0-9_]+/?$',
]
